...
# plot
ggplot(filter(ETATE_CTIweights.df), aes(x=CTI, y=CTIweights)) + 
  ...
  facet_grid(time ~ gamma) +
  scale_y_continuous(breaks = seq(min(0), max(2), by = 1), sec.axis = sec_axis(~ . , name = TeX("$J =$"), breaks = NULL, labels = NULL)) +
  scale_x_continuous(breaks = seq(min(2), max(10), by = 1), sec.axis = sec_axis(~ . , name = TeX("$\\gamma =$"), breaks = NULL, labels = NULL)) +
  theme_bw() +
  theme(panel.grid.minor.x = element_blank()) +
  labs(title="exposure time-averaged treatment effect (ETATE) as a \nweighted sum of calendar time effect (CTE) estimands", x ="CTE", y = "CTE scaled weights")
...
ETATE_CTIweights.df %>%
  ...
  ggplot(aes(x=CTI, y=CTIweights)) + 
  # geom_dotplot(binaxis='y', stackdir='center', color="blue", fill="blue", dotsize=2.5) +
  geom_point(color="black", fill="black", size=1.25)+
...
# ggsave(filename = "ETATE_CTIweights.tiff", plot = last_plot(),
#        width=5, height=4, units="in",
#        dpi=800, device='tiff')
ggsave(filename = "Kenneth_Menglin_Lee_Figure_5.tiff", plot = last_plot(),
       width=5, height=4, units="in",
       dpi=800, device='tiff')
ggsave(filename = "Kenneth_Menglin_Lee_Figure_5.png", plot = last_plot(),
       width=5, height=4, units="in",
       dpi=300, device='png')
```
...
colors <- c("CTE" = "darkred", "True CTATE"="#F8766D", "Est. ETATE" = "#00BA38")
ggplot(CTEtestscenario, aes(x=factor(CTE), y=CTE_effect, group=1)) + 
  geom_point(aes(color="CTE"),fill="darkred") +
  geom_line(aes(color="CTE")) +
  geom_hline(yintercept=0, linetype="dashed", color = "black") +
  geom_hline(aes(yintercept=CTE_weight, color = "Est. ETATE"), linetype="solid", lwd=0.75) +
  geom_hline(aes(yintercept=CTATE, color = "True CTATE"), linetype="solid", lwd=0.75) +
  theme_bw() +
  facet_grid(~ scenario) +
  labs(title="Scenarios with different CTE as analyzed by an ETATE estimator", x ="Calendar time (j)", y = "CTE value", color=NULL) +
  scale_color_manual(values = colors, breaks = c("CTE", "True CTATE", "Est. ETATE")) +
...
# plot
ggplot(filter(CTATE_ETIweights.df), aes(x=ETI, y=ETIweights)) + 
  # geom_dotplot(binaxis='y', stackdir='center', color="blue", fill="blue", dotsize=3.75) +
  geom_point(color="blue", fill="blue", size=1) +
  geom_hline(yintercept=1, linetype="dashed", color = "red") +
  geom_hline(yintercept=0, linetype="dashed", color = "black") +
  # facet_grid(timelabels ~ gammalabels) +
  facet_grid(time ~ gamma) +
  scale_y_continuous(breaks = seq(min(0), max(4), by = 2), sec.axis = sec_axis(~ . , name = TeX("$J =$"), breaks = NULL, labels = NULL)) +
  scale_x_continuous(breaks = seq(min(1), max(9), by = 1), sec.axis = sec_axis(~ . , name = TeX("$\\gamma =$"), breaks = NULL, labels = NULL)) +
  theme_bw() +
  theme(panel.grid.minor.x = element_blank()) +
  labs(title="calendar time-averaged treatment effect (CTATE) as a \nweighted sum of exposure time effect (ETE) estimands", x ="ETE", y = "ETE scaled weights")
# width 500, height 475
...
CTATE_ETIweights.df %>%
  ...
  labs(title="calendar time-averaged treatment effect (CTATE) as a \nweighted sum of exposure time effect (ETE) estimands", x ="ETE", y = "ETE scaled weights")
# width 500, height 400
# ggsave(filename = "CTATE_ETIweights.tiff", plot = last_plot(),
#        width=5, height=4, units="in",
#        dpi=800, device='tiff')
ggsave(filename = "Kenneth_Menglin_Lee_Figure_7.tiff", plot = last_plot(),
       width=5, height=4, units="in",
       dpi=800, device='tiff')
ggsave(filename = "Kenneth_Menglin_Lee_Figure_7.png", plot = last_plot(),
       width=5, height=4, units="in",
       dpi=300, device='png')
```
...
colors <- c("ETE" = "darkgreen", "True ETATE" = "#00BA38", "Est. CTATE"="#F8766D")
ggplot(ETEtestscenario, aes(x=factor(ETE), y=ETE_effect, group=1)) + 
  geom_point(aes(color="ETE"), fill="darkgreen") +
  geom_line(aes(color="ETE")) +
  geom_hline(yintercept=0, linetype="dashed", color = "black") +
  geom_hline(aes(yintercept=ETE_weight, color = "Est. CTATE"), linetype="solid", lwd=0.75) +
  geom_hline(aes(yintercept=ETATE, color = "True ETATE"), linetype="solid", lwd=0.75) +
  theme_bw() +
  facet_grid(~ scenario) +
  labs(title="Scenarios with different ETE as analyzed by a CTATE estimator", x ="Exposure time (s)", y = "ETE value", color=NULL) +
  scale_y_continuous(breaks=c(0,0.25,0.5,0.75,1)) +
  scale_color_manual(values = colors, breaks = c("ETE", "True ETATE", "Est. CTATE")) +
  theme(legend.position="bottom")
...
# plot (for Appendix)
ggplot(IT_ETIweights.df, aes(x=ETI, y=ETIweights)) + 
  # geom_dotplot(binaxis='y', stackdir='center', color="blue", fill="blue", dotsize=3.75) +
  geom_point(color="blue", fill="blue", size=1)+
  geom_hline(yintercept=1, linetype="dashed", color = "red") +
  geom_hline(yintercept=0, linetype="dashed", color = "black") +
...
IT_ETIweights.df %>%
  ...
  ggplot(aes(x=ETI, y=ETIweights)) + 
  # geom_dotplot(binaxis='y', stackdir='center', color="blue", fill="blue", dotsize=2.5) +
  geom_point(color="blue", fill="blue", size=1.25)+
  geom_hline(yintercept=1, linetype="dashed", color = "red") +
  geom_hline(yintercept=0, linetype="dashed", color = "black") +
  # facet_grid(timelabels ~ gammalabels) +
  facet_grid(time ~ gamma) +
...
colors <- c("ETE" = "darkgreen", "True ETATE" = "#00BA38", "Est. IT"="#619CFF")
ggplot(ETEtestscenario, aes(x=factor(ETE), y=ETE_effect, group=1)) + 
  geom_point(aes(color="ETE"), fill="darkgreen") +
  geom_line(aes(color="ETE")) +
  geom_hline(yintercept=0, linetype="dashed", color = "black") +
  geom_hline(aes(yintercept=ETE_weight, color = "Est. IT"), linetype="solid", lwd=0.75) +
  geom_hline(aes(yintercept=ETATE, color = "True ETATE"), linetype="solid", lwd=0.75) +
  theme_bw() +
  facet_grid(~ scenario) +
  labs(title="Scenarios with different ETE as analyzed by an IT estimator", x ="Exposure time (s)", y = "ETE value", color=NULL) +
  scale_y_continuous(breaks=c(0,0.25,0.5,0.75,1)) +
  scale_color_manual(values = colors, breaks = c("ETE", "True ETATE", "Est. IT")) + 
  theme(legend.position="bottom")
# width 600, height 300
```
...
# plot
ggplot(filter(IT_CTIweights.df), aes(x=CTI, y=CTIweights)) + 
  # geom_dotplot(binaxis='y', stackdir='center', color="blue", fill="blue", dotsize=3.75) +
  geom_point(color="blue", fill="blue", size=1)+
  geom_hline(yintercept=1, linetype="dashed", color = "red") +
  geom_hline(yintercept=0, linetype="dashed", color = "black") +
  # facet_grid(timelabels ~ gammalabels) +
  # facet_grid(timelabels ~ .) +
  facet_grid(time ~ .) +
  scale_y_continuous(sec.axis = sec_axis(~ . , name = TeX("$J =$"), breaks = NULL, labels = NULL)) +
...
IT_CTIweights.df %>%
  ...
  ggplot(aes(x=CTI, y=CTIweights)) + 
  # geom_dotplot(binaxis='y', stackdir='center', color="blue", fill="blue", dotsize=2.5) +
  geom_point(color="blue", fill="blue", size=1.75)+
  geom_hline(yintercept=1, linetype="dashed", color = "red") +
  geom_hline(yintercept=0, linetype="dashed", color = "black") +
  # facet_grid(timelabels ~ gammalabels) +
  # facet_grid(timelabels ~ .) +
...
CTE_effect5 <- c(0, 0.9, 0.97, 1, 1, 0.97, 0.9, 0)
# CTE_effect5 <- c(0, 0.1, 0.98, 1, 1, 0.98, 0.1, 0)
# CTE_effect6 <- c(1, 0.1, 0.03, 0, 0, 0.03, 0.1, 1)
...
colors <- c("CTE" = "darkred", "True CTATE"="#F8766D", "Est. IT" = "#619CFF")
ggplot(IT_CTEtestscenario, aes(x=factor(CTE), y=CTE_effect, group=1)) + 
  geom_point(aes(color="CTE"), fill="darkred") +
  geom_line(aes(color="CTE")) +
  geom_hline(yintercept=0, linetype="dashed", color = "black") +
  geom_hline(aes(yintercept=CTE_weight, color="Est. IT"), linetype="solid", lwd=0.75) +
  geom_hline(aes(yintercept=CTATE, color="True CTATE"), linetype="solid", lwd=0.75) +
  theme_bw() +
  facet_grid(~ scenario) +
  labs(title="Scenarios with different CTE as analyzed by an IT estimator", x ="Calendar time (j)", y = "CTE value", color=NULL) +
    scale_color_manual(values = colors, breaks = c("CTE", "True CTATE", "Est. IT")) +
    theme(legend.position="bottom")
# width 600, height 300
```
...
# Combined Figure
```{r ** Combine scenario figures}
library(ggplot2)
library(dplyr)
library(cowplot)
# colors <- c("CTE" = "darkred", "True CTATE"="#F8766D", "Est. ETATE" = "#00BA38")
linetype1 <- c("True CTATE"="solid", "Est. ETATE" = "dashed")
linetype2 <- c("True ETATE" = "solid", "Est. CTATE"="dashed")
linetype3 <- c("True ETATE" = "solid", "Est. IT"="dashed")
linetype4 <- c("True CTATE"="solid", "Est. IT" = "dashed")

cowplot::plot_grid(
    ggplot(ETEtestscenario, aes(x=factor(ETE), y=ETE_effect, group=1)) + 
    # geom_point(aes(color="ETE"), fill="darkgreen") +
    # geom_line(aes(color="ETE")) +
    geom_point(color="gray70", fill="gray70") +
    geom_line(linetype = "solid", color="gray70", lwd=0.75) +
    geom_hline(yintercept=0, linetype="dotted", color = "black") +
    # geom_hline(aes(yintercept=ETE_weight, color = "Est. IT"), linetype="solid", lwd=0.75) +
    # geom_hline(aes(yintercept=ETATE, color = "True ETATE"), linetype="solid", lwd=0.75) +
    geom_hline(aes(yintercept=ETE_weight, linetype = "Est. IT"), color="black") +
    geom_hline(aes(yintercept=ETATE, linetype = "True ETATE"), color="black") +
    theme_bw() +
    facet_grid(~ scenario) +
    labs(title="Scenarios with different ETE as analyzed by an IT estimator", x ="Exposure time (s)", y = "ETE value", color=NULL) +
    # scale_y_continuous(breaks=c(0,0.25,0.5,0.75,1)) +
    scale_y_continuous(breaks=c(0,0.5,1), limits= c(-0.4, 1.4)) +
    # scale_color_manual(values = colors, breaks = c("ETE", "True ETATE", "Est. IT")) + 
    scale_linetype_manual(values = linetype3, breaks = c("True ETATE", "Est. IT")) + 
  ...
  ggplot(IT_CTEtestscenario, aes(x=factor(CTE), y=CTE_effect, group=1)) + 
    ...
    # geom_hline(aes(yintercept=CTE_weight, color="Est. IT"), linetype="solid", lwd=0.75) +
    # geom_hline(aes(yintercept=CTATE, color="True CTATE"), linetype="solid", lwd=0.75) +
    geom_hline(aes(yintercept=CTE_weight, linetype="Est. IT"), color="black") +
    geom_hline(aes(yintercept=CTATE, linetype="True CTATE"), color="black") +
    theme_bw() +
    facet_grid(~ scenario) +
    labs(title="Scenarios with different CTE as analyzed by an IT estimator", x ="Calendar time (j)", y = "CTE value", color=NULL) +
    # scale_y_continuous(breaks=c(0,0.25,0.5,0.75,1)) +
    scale_y_continuous(breaks=c(0,0.5,1), limits= c(-0.4, 1.4)) +
    # scale_color_manual(values = colors, breaks = c("CTE", "True CTATE", "Est. IT")) +
    scale_linetype_manual(values = linetype4, breaks = c("True CTATE", "Est. IT")) +
    theme(legend.position="right", legend.title=element_blank())
  ,
  ggplot(CTEtestscenario, aes(x=factor(CTE), y=CTE_effect, group=1)) + 
    # geom_point(aes(color="CTE"),fill="black") +
    # geom_line(aes(linetype = "CTE"), color="gray50", lwd=0.90) +
    geom_point(color="gray70", fill="gray70") +
    geom_line(linetype = "solid", color="gray70", lwd=0.75) +
    geom_hline(yintercept=0, linetype="dotted", color = "black") +
    geom_hline(aes(yintercept=CTE_weight, linetype="Est. ETATE"), color = "black") +
    geom_hline(aes(yintercept=CTATE, linetype="True CTATE"), color = "black") +
    theme_bw() +
    facet_grid(~ scenario) +
    labs(title="Scenarios with different CTE as analyzed by an ETATE estimator", x ="Calendar time (j)", y = "CTE value", color=NULL) +
    ...
    scale_y_continuous(breaks=c(0,0.5,1), limits= c(-0.4, 1.4)) +
    # scale_color_manual(values = colors, breaks = c("CTE", "True CTATE", "Est. ETATE")) +
    scale_linetype_manual(values = linetype1, breaks = c("True CTATE", "Est. ETATE")) +
    theme(legend.position="right", legend.title=element_blank())
  ,
  ggplot(ETEtestscenario, aes(x=factor(ETE), y=ETE_effect, group=1)) + 
    # geom_point(aes(color="ETE"), fill="darkgreen") +
    ...
    geom_line(linetype = "solid", color="gray70", lwd=0.75) +
    geom_hline(yintercept=0, linetype="dotted", color = "black") +
    geom_hline(aes(yintercept=ETE_weight, linetype = "Est. CTATE"), color="black") +
    geom_hline(aes(yintercept=ETATE, linetype = "True ETATE"), color="black") +
    theme_bw() +
    facet_grid(~ scenario) +
    labs(title="Scenarios with different ETE as analyzed by a CTATE estimator", x ="Exposure time (s)", y = "ETE value", color=NULL) +
    ...
    scale_y_continuous(breaks=c(0,0.5,1), limits= c(-0.4, 1.4)) +
    # scale_color_manual(values = colors, breaks = c("ETE", "True ETATE", "Est. CTATE")) +
    scale_linetype_manual(values = linetype2, breaks = c("True ETATE", "Est. CTATE")) +
    theme(legend.position="right", legend.title=element_blank())
  ,
  nrow=4, labels=c("A.","B.","C.","D.")
)
# width = 660, height = 600
# ggsave(filename = "Figure_Scenarios.tiff", plot = last_plot(),
#        width=6.6, height=7, units="in",
#        dpi=800, device='tiff')
# ggsave(filename = "Figure_Scenarios.png", plot = last_plot(),
#        width=6.6, height=7, units="in",
#        dpi=300, device='png')
...
ggplot(ETEtestscenario, aes(x=factor(ETE), y=ETE_effect, group=1)) + 
  ...
  scale_linetype_manual(values = linetype3, breaks = c("True ETATE", "Est. IT")) + 
  theme(legend.position="right", legend.title=element_blank())
ggsave(filename = "Kenneth_Menglin_Lee_Figure_3.tiff", plot = last_plot(),
       width=6.6, height=2.5, units="in",
       dpi=800, device='tiff')
ggsave(filename = "Kenneth_Menglin_Lee_Figure_3.png", plot = last_plot(),
       width=6.6, height=2.5, units="in",
       dpi=300, device='png')
...
ggplot(IT_CTEtestscenario, aes(x=factor(CTE), y=CTE_effect, group=1)) + 
  ...
  scale_linetype_manual(values = linetype4, breaks = c("True CTATE", "Est. IT")) +
  theme(legend.position="right", legend.title=element_blank())
ggsave(filename = "Kenneth_Menglin_Lee_Figure_4.tiff", plot = last_plot(),
       width=6.6, height=2.5, units="in",
       dpi=800, device='tiff')
ggsave(filename = "Kenneth_Menglin_Lee_Figure_4.png", plot = last_plot(),
       width=6.6, height=2.5, units="in",
       dpi=300, device='png')
...
ggplot(CTEtestscenario, aes(x=factor(CTE), y=CTE_effect, group=1)) + 
  ...
  scale_linetype_manual(values = linetype1, breaks = c("True CTATE", "Est. ETATE")) +
  theme(legend.position="right", legend.title=element_blank())
ggsave(filename = "Kenneth_Menglin_Lee_Figure_6.tiff", plot = last_plot(),
       width=6.6, height=2.5, units="in",
       dpi=800, device='tiff')
ggsave(filename = "Kenneth_Menglin_Lee_Figure_6.png", plot = last_plot(),
       width=6.6, height=2.5, units="in",
       dpi=300, device='png')
...
ggplot(ETEtestscenario, aes(x=factor(ETE), y=ETE_effect, group=1)) + 
  ...
  scale_linetype_manual(values = linetype2, breaks = c("True ETATE", "Est. CTATE")) +
  theme(legend.position="right", legend.title=element_blank())
ggsave(filename = "Kenneth_Menglin_Lee_Figure_8.tiff", plot = last_plot(),
       width=6.6, height=2.5, units="in",
       dpi=800, device='tiff')
ggsave(filename = "Kenneth_Menglin_Lee_Figure_8.png", plot = last_plot(),
       width=6.6, height=2.5, units="in",
       dpi=300, device='png')
```
